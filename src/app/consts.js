...
export const projects = [
 ...
 export const designProjects = [
    {
      title: "Brand Refresh for UBCMA",
      time: "Fall 2023",
      image: "/design/ubcma-brand.png",
      tech: ["Figma", "Illustrator"],
      description: "A rebranding project involving new visuals, typography, and digital assets for UBCMA.",
      slug: "ubcma-brand-refresh",
    },
    {
      title: "Hackathon Identity Design",
      time: "Spring 2024",
      image: "/design/hackathon-id.png",
      tech: ["Figma", "Photoshop"],
      description: "Designed the brand identity and marketing materials for a student-led hackathon.",
      slug: "hackathon-identity",
    },
  ];  
